...
%acronumy
\acrodef{HHC}{Home Health Care}
\acrodef{HCS}{Home Care Service}
\acrodef{SFFH}{State Foundation Family Health}
\acrodef{HHCP}{Home Health Care Problem}
\acrodef{HHCSP}{Home Health Care Scheduling Problem}
\acrodef{HHCRSP}{Home Health Care Routing and Scheduling Problem}

\acrodef{NSP}{Nurse Scheduling Problem}

\acrodef{VRP}{Vehicle Routing Problem}
\acrodef{VRPTW}{Vehicle Routing Problem With Time Window}

\acrodef{TSP}{Traveling Salesman Problem}
\acrodef{MTSP}{Multiple Traveling Salesman Problem}
\acrodef{TSPTW}{Traveling Salesman Problem with Time Window}


\acrodef{GRASP}{Greedy Randomized Adaptative Search Procedure}
\acrodef{AICS}{Adaptative Iterated Construction Search}
\acrodef{DLS}{Dynamic Local Search}
\acrodef{ILS}{Iterated Local Search}
\acrodef{VNS}{Variable Neighborhood Search}
\acrodef{VDS}{Variable Depth Search}
...
\acrodef{LIP}{Linear Integer Programming}
...
\title{AN CONSTRAINT PROGRAMMING FOR HOME HEALTH CARE ROUTE AND SCHEDULING PROBLEM}
...
\include{chapter_constraint_programming}
\include{chapter_RSP}
\include{chapter_HHCRSP}
\include{chapter_RSL}
%\include{Constraint Programming}
%\include{Computational tests}
%\include{Conclusion}
